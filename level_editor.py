...
trampoline_img = pygame.image.load('img/trampoline.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 3:
					#enemy blocks
					img = pygame.image.load('enemy\L1.png')
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size * 0.25) - 50))
				...
				if world_data[row][col] == 9:
					#trampoline
					img = pygame.transform.scale(trampoline_img, (tile_size, tile_size))
					screen.blit(img, (col * tile_size, row * tile_size))
